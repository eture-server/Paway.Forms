...
namespace Paway.Forms
{
    ...
    internal abstract class NativeMethods
    {
        ...
        /// <returns></returns>
        [DllImport("user32.dll", CharSet = CharSet.Auto)]
        internal static extern bool DeleteMenu(IntPtr hMenu, int uPosition, int uFlags);
        /// <summary>
        /// 追加菜单条目
        /// </summary>
        [DllImport("user32.dll", CharSet = CharSet.Unicode)]
        internal static extern int AppendMenu(IntPtr hMenu, int Flagsw, IntPtr IDNewItem, string lpNewItem);
        /// <summary>
        /// 插入菜单条目
        /// </summary>
        [DllImport("user32.dll", CharSet = CharSet.Unicode)]
        internal static extern int InsertMenu(IntPtr hMenu, int uFlags, int Flagsw, IntPtr IDNewItem, string lpNewItem);
        /// <summary>
        /// 该函数在指定位置显示快捷菜单，并跟踪菜单项的选择
        /// </summary>
        [DllImport("user32.dll")]
        internal static extern int TrackPopupMenu(IntPtr hMenu, int uFlags, int x, int y, int nReserved, IntPtr hWnd, ref RECT rect);
        ...
        /// <returns></returns>
        [DllImport("user32.dll", ExactSpelling = true, SetLastError = true)]
        internal static extern bool UpdateLayeredWindow(IntPtr hWnd, IntPtr hdcDst, ref POINT pptDst, ref SIZE psize, IntPtr hdcSrc, ref POINT ppSrc, int crKey, ref BLENDFUNCTION pblend, int dwFlags);
        ...
        /// </summary>
        [DllImport("User32.dll")]
        internal static extern int SendMessage(IntPtr hWnd, int Msg, int wParam, ref UserDataStruct lParam);

        #endregion

        #region 窗体显示-internal
        /// <summary>
        ...
        /// <summary>
        /// </summary>
        internal static int LowerWord(int value)
        {
            return value & 0xFFFF;
        }
        /// <summary>
        /// </summary>
        internal static int HightWord(int value)
        {
            return value >> 16;
        }
