...
namespace Paway.Win32
{
    ...
    public class NativeMethods
    {
        ...
        [DllImport("Kernel32.dll")]
        internal static extern int ReadProcessMemory(IntPtr hProcess, IntPtr lpBaseAddress, [Out] byte[] lpBuffer,
        ...
        /// <returns></returns>
        [DllImport("Kernel32.dll")]
        internal static extern int WriteProcessMemory(IntPtr hProcess, IntPtr lpBaseAddress, ref int lpBuffer, int nSize,
            ref int lpNumberOfByteRead);
        ...
        public static extern bool UpdateLayeredWindow(IntPtr hwnd, IntPtr hdcDst, ref SIZE pptDst, ref SIZE psize,
        ...
        /// <returns></returns>
        [DllImport("user32.dll")]
        internal static extern IntPtr FindWindowEx(IntPtr hwndParent, IntPtr hwndChildAfter, string lpClassName,
            string lpWindowName);
        ...
        public static string GetLastErrorString(int code)
        {
            switch (code)
            {
                ...
                case 1635:
                    return "无法打开修补程序包。请验证修补程序包是否存在，是否可以访问；或者与应用程序供应商联系，验证这是否是 Windows 安装服务的修补程序包";
                case 1636:
                ...
                case 3108:
                    return
                        "NETWKSTA.SYS 的 DosDevIoctl 或 DosFsCtl 调用失败。显示的数据为以下格式:DWORD 值代表调用 Ioctl 或 FsCtl 的 CS:IP WORD 错误代码WORD Ioctl 或 FsCtl 号";
                case 3111:
                ...
                case 3302:
                    return "Remote Admin";
                case 3303:
                    return "Logon server share";
                case 3304:
                    return "网络出错";
                case 3400:
                    return "内存不足，无法启动工作站服务";
                case 3401:
                    return "读取 LAMAN.INI 文件的 NETWORKS 项目出错";
                case 3404:
                    return "LAMAN.INI 文件中的 NETWORKS 项目太多";
                case 3408:
                    return "程序无法用在此操作系统";
                case 3409:
                    return "已经安装转发程序";
                case 3411:
                    return "安装 NETWKSTA.SYS 时出错。请按 ENTER 继续";
                case 3412:
                    return "求解程序链接问题";
                case 3419:
                    return "您已经打开文件或设备，强制断开会造成数据丢失";
                case 3420:
                    return "内部用的默认共享";
                case 3421:
                    return "信使服务";
                ...
                case 3512:
                    return "软件需要新版的操作系统";
                case 3513:
                    return "数据多于 Windows 2000 所能够返回的";
                case 3515:
                    return "此命令只能用在 Windows 2000 域控制器";
                case 3516:
                    return "这个指令不能用于一个 Windows 2000 域控制器";
                case 3520:
                    return "已经启动以下 Windows 2000 服务";
                case 3525:
                    return "停止工作站服务也会同时停止服务器服务 ";
                case 3526:
                    return "工作站有打开的文件";
                case 3533:
                    return "服务正在启动或停止中，请稍候片刻后再试一次";
                case 3534:
                    return "服务没有报告任何错误";
                case 3535:
                    return "正在控制设备时出错";
                case 3660:
                    return "这些工作站在这台服务器上有会话";
                case 3661:
                    return "这些工作站有会话打开了此台服务器上的文件";
                case 3666:
                    return "消息别名已经转发出去";
                case 3670:
                    return "您有以下的远程连接";
                ...
                case 3677:
                    return "不记录新的网络连接";
                case 3678:
                    return "保存配置文件时出错，原先记录的网络连接状态没有更改";
                case 3679:
                    return "读取配置文件时出错";
                case 3682:
                    return "没有启动任何网络服务";
                case 3683:
                    return "清单是空的";
                case 3689:
                    return "工作站服务已经在运行中，Windows 2000 会忽略工作站的命令选项";
                case 3694:
                    return "在打印作业正在后台处理到队列时，无法删除共享的队列";
                case 3710:
                    return "打开帮助文件时出错";
                case 3711:
                    return "帮助文件是空的";
                case 3712:
                    return "帮助文件已经损坏";
                case 3714:
                    return "这是专为那些安装旧版软件的系统提供的操作";
                case 3716:
                    return "设备类型未知";
                case 3717:
                    return "日志文件已经损坏";
                case 3718:
                    return "程序文件名后必须以 .EXE 结束";
                case 3719:
                    return "找不到匹配的共享，因此没有删除";
                case 3720:
                    return "用户记录中的 “单位/星期” 的值不正确";
                case 3725:
                    return "删除共享时出错";
                case 3726:
                    return "用户名无效";
                ...
                case 3737:
                    return "权限字符串包含无效的权限";
                case 3738:
                    return "您只能在打印机或通讯设备上执行这项操作";
                case 3743:
                    return "服务器没有设置远程管理的功能";
                case 3752:
                    return "这台服务器上没有用户的会话";
                case 3756:
                    return "响应无效";
                case 3757:
                    return "没有提供有效的响应";
                case 3758:
                    return "提供的目标清单与打印机队列目标清单不匹配";
                case 3761:
                    return "指定的时间范围中结束的时间比开始的时间早";
                case 3764:
                    return "提供的时间不是整点";
                case 3765:
                    return "12 与 24 小时格式不能混用";
                case 3767:
                    return "提供的日期格式无效";
                case 3768:
                    return "提供的日期范围无效";
                case 3769:
                    return "提供的时间范围无效";
                case 3770:
                    return "NET USER 的参数无效。请检查最短的密码长度和/或提供参数";
                case 3771:
                    return "ENABLESCRIPT 的值必须是 YES";
                case 3773:
                    return "提供的国家(地区)代码无效";
                case 3774:
                    return "用户已经创建成功，但是无法添加到USERS 本地组中";
                case 3775:
                    return "提供的用户上下文无效";
                case 3777:
                    return "文件发送功能已不再支持";
                case 3778:
                    return "您可能没有指定 ADMIN$ 及 IPC$ 共享的路径";
                case 3784:
                    return "只有磁盘共享可以标记为可以缓存";
                case 3802:
                    return "此计划日期无效";
                case 3803:
                    return "LANMAN 根目录无法使用";
                case 3804:
                    return "SCHED.LOG 文件无法打开";
                case 3805:
                    return "服务器服务尚未启动";
                case 3806:
                    return "AT 作业标识不存在";
                case 3807:
                    return "AT 计划文件已损坏";
                case 3808:
                    return "因为 AT 计划文件发生问题，所以无法运行删除操作";
                case 3809:
                    return "命令行不得超过 259 个字符";
                case 3810:
                    return "因为磁盘已满，所以 AT 计划文件无法更新";
                case 3812:
                    return "AT 计划文件无效。请删除此文件并创建新的文件";
                case 3813:
                    return "AT 计划文件已经删除";
                case 3814:
                    return
                        "此命令的语法是:AT [id] [/DELETE]AT 时间 [/EVERY:日期 | /NEXT:日期] 命令AT 命令会在以后的指定日期及时间，安排程序在服务器上运行。它也会显示安排运行的程序及命令的清单。您可以将日期指定为M、T、W、Th、F、Sa、Su 或 1-31 的格式。您可以将时间指定为HH:MM的二十四小时格式";
                case 3815:
                    return "AT 命令已经超时。请稍后再试一次";
                case 3816:
                    return "用户帐户的密码使用最短期限不得大于密码最长使用期限";
                case 3817:
                    return "指定的数值与安装下层软件的服务器不兼容。请指定较小的值";
                case 3901:
                    return "****";
                case 3902:
                    return "**** 意外到达消息的结尾 ****";
                ...
                case 3920:
                    return "已经没有可用的驱动器号";
                case 3936:
                    return "这台计算机目前没有配置成使用一个指定的 SNTP 服务器";
                case 3953:
                    return "语法错误";
                case 3960:
                    return "指定的文件号码无效";
                ...
                case 3963:
                    return "指定的用户或组帐户找不到";
                case 3965:
                    return "已添加用户，但 NetWare 的文件和打印服务无法启用";
                case 3966:
                    return "没有安装 NetWare 的文件和打印服务";
                case 3967:
                    return "无法为 NetWare 的文件和打印服务设置用户属性";
                case 3969:
                    return "NetWare 兼容登录";
                case 4000:
                    return "WINS 在处理命令时遇到错误";
                case 4001:
                    return "本地的 WINS 不能删除";
                case 4002:
                    return "文件导入操作失败";
                case 4003:
                    return "备份操作失败。是否先前已作过完整备份";
                case 4004:
                    return "备份操作失败。请检查您备份数据库的目录";
                case 4005:
                    return "WINS 数据库中没有这个名称";
                case 4006:
                    return "不允许复制一个尚未配置的伙伴";
                case 4100:
                    return "DHCP 客户获得一个在网上已被使用的 IP 地址。直到 DHCP 客户可以获得新的地址前，本地接口将被禁用";
                case 4200:
                    return "无法识别传来的 GUID 是否为有效的 WMI 数据提供程序";
                case 4201:
                    return "无法识别传来的实例名是否为有效的 WMI 数据提供程序";
                case 4202:
                    return "无法识别传来的数据项目标识符是否为有效的 WMI 数据提供程序";
                case 4203:
                    return "无法完成 WMI 请求，应该重试一次";
                case 4204:
                    return "找不到 WMI 数据提供程序";
                case 4205:
                    return "WMI 数据提供程序引用到一个未注册的实例组";
                case 4206:
                    return "WMI 数据块或事件通知已启用";
                case 4207:
                    return "WMI 数据块不再可用";
                case 4208:
                    return "WMI 数据服务无法使用";
                case 4209:
                    return "WMI 数据提供程序无法完成要求";
                case 4210:
                    return "WMI MOF 信息无效";
                case 4211:
                    return "WMI 注册信息无效";
                case 4212:
                    return "WMI 数据块或事件通知已禁用";
                case 4213:
                    return "WMI 数据项目或数据块为只读";
                case 4214:
                    return "WMI 数据项目或数据块不能更改";
                case 4300:
                    return "媒体标识符没有表示一个有效的媒体";
                case 4301:
                    return "库标识符没有表示一个有效的库";
                case 4302:
                    return "媒体缓冲池标识符没有表示一个有效的媒体缓冲池";
                case 4303:
                    return "驱动器和媒体不兼容或位于不同的库中";
                case 4304:
                    return "媒体目前在脱机库中，您必须联机才能运行这个操作";
                case 4305:
                    return "操作无法在脱机库中运行";
                case 4306:
                    return "库、驱动器或媒体缓冲池是空的";
                case 4307:
                    return "库、磁盘或媒体缓冲池必须是空的，才能运行这个操作";
                case 4308:
                    return "在这个媒体缓冲池或库中目前没有可用的媒体";
                case 4309:
                    return "这个操作所需的资源已禁用";
                case 4310:
                    return "媒体标识符没有表示一个有效的清洗器";
                case 4311:
                    return "无法清洗驱动器或不支持清洗";
                case 4312:
                    return "对象标识符没有表示一个有效的对象";
                case 4313:
                    return "无法读取或写入数据库";
                case 4314:
                    return "数据库已满";
                case 4315:
                    return "媒体与设备或媒体缓冲池不兼容";
                case 4316:
                    return "这个操作所需的资源不存在";
                case 4317:
                    return "操作标识符不正确";
                ...
                case 4319:
                    return "设备未就绪";
                case 4320:
                    return "操作员或系统管理员拒绝了请求";
                case 4321:
                    return "驱动器标识符不代表一个有效的驱动器";
                case 4322:
                    return "程序库已满。没有可使用的插槽";
                case 4323:
                    return "传输程序不能访问媒体";
                case 4324:
                    return "无法将媒体加载到驱动器中";
                ...
                case 4327:
                    return "无法检索传输的状态";
                case 4328:
                    return "因为传输已在使用中，所以无法使用";
                case 4329:
                    return "无法打开或关闭弹入/弹出端口";
                case 4330:
                    return "因为媒体在驱动器中，无法将其弹出";
                case 4331:
                    return "清洗器插槽已被保留";
                case 4332:
                    return "没有保留清洗器插槽";
                case 4333:
                    return "清洗器墨盒已进行了最大次数的驱动器清洗";
                case 4334:
                    return "意外媒体标识号";
                case 4335:
                    return "在这个组或源中最后剩下的项目不能被删除";
                case 4336:
                    return "提供的消息超过了这个参数所允许的最大尺寸";
                case 4337:
                    return "该卷含有系统和页面文件";
                case 4338:
                    return "由于库中至少有一个驱动器可以支持该媒体类型，不能从库中删除媒体类型";
                case 4339:
                    return "由于没有可以使用的已被启动的驱动器，无法将该脱机媒体装入这个系统";
                case 4340:
                    return "(Y/N) [Y]";
                case 4341:
                    return "(Y/N) [N]";
                ...
                case 4389:
                    return "Thursday";
                case 4390:
                    return "此文件或目录不是一个重解析点";
                case 4391:
                    return "重解析点的属性不能被设置，因为它与已有的属性冲突";
                case 4392:
                    return "在重解析点缓冲区中的数据无效";
                case 4393:
                    return "在重解析点缓冲区中的标签无效";
                case 4394:
                    return "请求中指定的标签和重解析点中的不匹配";
                case 4395:
                    return "W";
                case 4396:
                    return "Th";
                ...
                case 4492:
                    return "服务器已隐藏";
                case 4500:
                    return "零备份存储在这个卷上不可用";
                case 4506:
                    return "登录的用户数量上限";
                case 4507:
                    return "同时可并存的管理员数量上限";
                case 4508:
                    return "资源共享数量上限";
                case 4509:
                    return "资源连接数量上限";
                ...
                case 4530:
                    return "未限制的服务器";
                case 4570:
                    return "强制用户在时间到期之后多久必须注销";
                case 4571:
                    return "多少次密码不正确后锁住帐户";
                case 4572:
                    return "密码最短使用期限 (天)";
                case 4573:
                    return "密码最长使用期限 (天)";
                ...
                case 4630:
                    return "接收的字节数";
                case 4631:
                    return "接收的服务器消息块 (SMB)";
                case 4632:
                    return "传输的字节数";
                case 4633:
                    return "传输的服务器消息块 (SMB)";
                case 4634:
                    return "读取操作";
                case 4635:
                    return "写入操作";
                ...
                case 4661:
                    return "密码已经更改成功";
                case 4664:
                    return "消息已经发给网络上所有的用户";
                case 4666:
                    return "消息已经送到此服务器上的所有用户";
                case 4696:
                    return "Windows NT Server";
                case 4697:
                    return "Windows NT Workstation";
                case 4698:
                    return "MS-DOS 增强型工作站";
                case 4700:
                    return "服务器名称 注释";
                case 4701:
                    return "资源共享名 类型 用途 注释";
                case 4702:
                    return "(UNC)";
                case 4703:
                    return "...";
                ...
                case 4803:
                    return "这台服务器的用户";
                case 4804:
                    return "用户已经按 Ctrl+Break 中断网络发送";
                case 4810:
                    return "名称 作业编号 大小 状态";
                case 4811:
                    return "作业";
                case 4812:
                    return "打印";
                ...
                case 4997:
                    return "程序 消息 时间";
                case 4999:
                    return "管理员已解除帐户的锁定状态";
                case 5000:
                    return "注销网络";
                case 5001:
                    return "因为其它资源需要它，不能将群集资源移到另一个组";
                case 5002:
                    return "找不到此群集资源的依存";
                case 5003:
                    return "因为已经处于依存状态，此群集资源不能依存于指定的资源";
                case 5004:
                    return "此群集资源未联机";
                case 5005:
                    return "此操作没有可用的群集节点";
                ...
                case 5013:
                    return "找不到群集组";
                case 5014:
                    return "因为群集组未联机，此操作不能完成";
                case 5015:
                    return "群集节点不是此资源的所有者";
                case 5016:
                    return "群集节点不是此资源的所有者";
                case 5017:
                    return "群集资源不能在指定的资源监视器中创建";
                case 5018:
                    return "群集资源不能通过资源监视器来联机";
                case 5019:
                    return "因为群集资源联机，此操作不能完成";
                case 5020:
                    return "由于是仲裁资源，群集资源不能被删除或脱机";
                case 5021:
                    return "由于没有能力成为仲裁资源，此群集不能使指定资源成为仲裁资源";
                case 5022:
                    return "群集软件正关闭";
                case 5023:
                    return "组或资源的状态不是执行请求操作的正确状态";
                case 5024:
                    return "属性已被存储，但在下次资源联机前，不是所有的修改将生效";
                case 5025:
                    return "由于不属于共享存储类别，群集不能使指定资源成为仲裁资源";
                case 5026:
                    return "由于是内核资源，无法删除群集资源";
                case 5027:
                    return "仲裁资源联机失败";
                case 5028:
                    return "无法成功创建或装入仲裁日志";
                case 5029:
                    return "群集日志损坏";
                case 5030:
                    return "由于该日志已超出最大限量，无法将记录写入群集日志";
                case 5031:
                    return "群集日志已超出最大限量";
                case 5032:
                    return "群集日志没有发现检查点记录";
                case 5033:
                    return "不满足日志所需的最小磁盘空间";
                case 5034:
                    return "群集节点未能控制仲裁资源，因为它被另一个活动节点拥有";
                case 5035:
                    return "这个操作的群集网络无效";
                case 5036:
                    return "此操作没有可用的群集节点";
                case 5037:
                    return "所有群集节点都必须运行才能执行这个操作";
                case 5038:
                    return "群集资源失败";
                case 5039:
                    return "该群集节点无效";
                ...
                case 5056:
                    return "该群集节点可以使用";
                case 5057:
                    return "该群集 IP 地址已在使用中";
                case 5058:
                    return "该群集节点没有中止";
                case 5059:
                    return "没有有效的群集安全上下文";
                case 5060:
                    return "该群集网络不是为内部群集通讯配置的";
                case 5061:
                    return "群集节点已经开始";
                case 5062:
                    return "群集节点已经坏了";
                ...
                case 5064:
                    return "群集网络已经脱机";
                case 5065:
                    return "群集节点已经是该群集的成员";
                case 5066:
                    return "该群集网络是唯一个为两个或更多活动群集节点进行内部群集通讯的配置。不能从网络上删除内部通讯能力";
                case 5067:
                    return "一个或更多的群集资源依靠网络来向客户提供服务。不能从网络上删除客户访问能力";
                case 5068:
                    return "该操作不能在群集资源上作为仲裁资源执行。您不能将仲裁资源脱机或修改它的所有者名单";
                case 5069:
                    return "该群集仲裁资源不允许有任何依存关系";
                case 5070:
                    return "该群集节点暂停";
                case 5071:
                    return "群集资源不能联机。所有者节点不能在这个资源上运行";
                case 5072:
                    return "群集节点没有准备好，不能执行所请求的操作";
                case 5073:
                    return "群集节点正在关闭";
                case 5074:
                    return "放弃群集节点加入操作";
                case 5075:
                    return "由于加入节点和支持者之间的软件版本不兼容，该群集加入操作失败";
                case 5076:
                    return "由于该群集已经到达其所能监督的资源限制，不能创建这个资源";
                case 5077:
                    return "系统配置在群集加入或形成操作时已更改。放弃加入或形成操作";
                case 5078:
                    return "找不到指定的资源种类";
                case 5079:
                    return "指定的节点不支持这种资源，这也许是由于版本不一致或是由于在这个节点上没有资源 DLL";
                case 5080:
                    return "该资源 DLL 不支持指定的资源名称。这可能是由于一个提供给源 DLL 名称是错误的(或经过更改的)";
                case 5081:
                    return "不能在 RPC 服务器上注册任何身份验证包";
                case 5082:
                    return "由于组的所有者不在组的首选列表中，不能将组联机。要改变组的所有者节点，请移动组";
                case 5083:
                    return "群集数据库的系列号已改变，或者与锁定程序节点不相容，因此加入操作没有成功。如果在加入操作期间群集数据库有任何改动，这都可能发生";
                case 5084:
                    return "资源在其当前状态下，资源监视器不允许执行失败操作。资源处于挂起状态时，这都可能发生";
                case 5085:
                    return "非锁定程序代码收到一个为全局更新保留锁定的请求";
                case 5086:
                    return "群集服务找不到仲裁磁盘";
                case 5087:
                    return "已备份的群集数据库可能已损坏";
                case 5088:
                    return "DFS 根目录已在这个群集节点中";
                case 5089:
                    return "由于与另一个现有属性冲突，未能修改资源属性";
                case 5090:
                    return "西班牙";
                case 5091:
                    return "丹麦";
                ...
                case 5104:
                    return "希伯莱";
                case 5153:
                    return "UPS 服务即将执行最后的关机操作";
                case 5170:
                    return "工作站必须用 NET START 才能启动";
                case 5175:
                    return "远程 IPC";
                case 5176:
                    return "远程管理";
                ...
                case 5296:
                    return "NET.HLP";
                case 5300:
                    return "网络控制块 (NCB) 请求运行成功。NCB 是相关数据";
                case 5301:
                    return "SEND DATAGRAM、SEND BROADCAST、ADAPTER STATUS 或 SESSION STATUS 的网络控制块 (NCB) 缓冲区长度无效。CB 是相关数据";
                case 5302:
                    return "网络控制块 (NCB) 指定的数据描述数组无效。NCB 是相关数据";
                case 5303:
                    return "网络控制块 (NCB) 指定的命令无效。NCB 是相关数据";
                case 5304:
                    return "网络控制块 (NCB) 指定的消息交换码无效。NCB 是相关数据";
                case 5305:
                    return "网络控制块 (NCB) 命令超时。会话可能异常终止。NCB 是相关数据";
                case 5306:
                    return "接收的网络控制块 (NCB) 消息不完整。NCB 是相关数据";
                case 5307:
                    return "网络控制块 (NCB) 指定的缓冲区无效。NCB 是相关数据";
                case 5308:
                    return "网络控制块 (NCB) 指定的会话号码没有作用。NCB 是相关数据";
                case 5309:
                    return "网卡没有任何资源可用。网络控制块 (NCB) 请求被拒绝。NCB 是相关数据";
                case 5310:
                    return "网络控制块 (NCB) 指定的会话已经关闭。NCB 是相关数据";
                case 5311:
                    return "网络控制块 (NCB) 命令已经取消。NCB 是相关数据";
                case 5312:
                    return "网络控制块 (NCB) 指定的消息块不合逻辑。NCB 是相关数据";
                case 5313:
                    return "该名称已经存在于本地适配器名称表中。网络控制块 (NCB) 请求被拒绝。NCB 是相关数据";
                case 5314:
                    return "网卡名称表已满。网络控制块 (NCB) 请求被拒绝。NCB 是相关数据";
                case 5315:
                    return "网络名称已经有活动的会话，现在取消注册。网络控制块 (NCB) 命令运行完毕。NCB 是相关数据";
                case 5316:
                    return "先前发出的 Receive Lookahead 命令对此会话仍起作用。网络控制块 (NCB) 命令被拒绝。NCB 是相关数据";
                case 5317:
                    return "本地会话表已满。网络控制块 (NCB) 请求被拒绝。NCB 是相关数据";
                case 5318:
                    return "拒绝打开网络控制块 (NCB) 会话，远程计算机上没有侦听命令在执行。NCB 是相关数据";
                case 5319:
                    return "网络控制块 (NCB) 指定的名称号码无效。NCB 是相关数据";
                case 5320:
                    return "网络控制块 (NCB) 中指定的调用名称找不到，或者没有应答。NCB 是相关数据";
                case 5321:
                    return "网络控制块 (NCB) 中指定的名称找不到。无法将“*”或00h 填入 NCB 名称。NCB 是相关数据";
                case 5322:
                    return "网络控制块 (NCB) 中指定的名称正用于远程适配器。NCB 是相关数据";
                case 5323:
                    return "网络控制块 (NCB) 中指定的名称已经删除。NCB 是相关数据";
                case 5324:
                    return "网络控制块 (NCB) 中指定的会话异常终止。NCB 是相关数据";
                case 5325:
                    return "网络协议在网络上检测两个或数个相同的名称。 网络控制块 (NCB) 是相关数据";
                case 5326:
                    return "收到意外的协议数据包。远程设备可能不兼容。网络控制块 (NCB) 是相关数据";
                case 5333:
                    return "NetBIOS 界面正忙。网络控制块 (NCB) 请求被拒绝。NCB 是相关数据";
                case 5334:
                    return "未完成的网络控制块 (NCB) 命令太多。NCB 请求被拒绝。NCB 是相关数据";
                case 5335:
                    return "网络控制块 (NCB) 中指定的适配器号无效。NCB 是相关数据";
                case 5336:
                    return "网络控制块 (NCB) 命令在取消的同时运行完毕。NCB 是相关数据";
                case 5337:
                    return "网络控制块 (NCB) 指定的名称已经保留。NCB 是相关数据";
                case 5338:
                    return "网络控制块 (NCB) 命令无法取消。NCB 是相关数据";
                case 5351:
                    return "同一个会话有多个网络控制块 (NCB)。NCB 请求被拒绝。NCB 是相关数据";
                case 5352:
                    return "网卡出错。唯一可能发出的 NetBIOS 命令是 NCB RESET。网络控制块 (NCB) 是相关数据";
                case 5354:
                    return "超过应用程序数目上限。网络控制区 (NCB) 请求被拒绝，NCB 是相关数据";
                case 5356:
                    return "请求的资源无法使用。网络控制块 (NCB) 请求被拒绝。NCB 是相关数据";
                case 5364:
                    return "系统出错。网络控制块 (NCB) 请求被拒绝。NCB 即为数据";
                case 5365:
                    return "“ROM 校验和”失败。网络控制块 (NCB) 请求被拒绝。NCB 是相关数据";
                case 5366:
                    return "RAM 测试失败。网络控制块 (NCB) 请求被拒绝。NCB 是相关数据";
                case 5367:
                    return "数字式环回失败。网络控制块 (NCB) 请求被拒绝。NCB 是相关数据";
                case 5368:
                    return "模拟式环回失败。网络控制块 (NCB) 请求被拒绝。NCB 是相关数据";
                case 5369:
                    return "界面失败。网络控制块 (NCB) 请求被拒绝。NCB 是相关数据";
                case 5370:
                    return "收到的网络控制块 (NCB) 返回码无法识别。NCB 是相关数据";
                case 5380:
                    return "网卡故障。网络控制块 (NCB) 请求被拒绝。NCB 是相关数据";
                case 5381:
                    return "网络控制块 (NCB) 命令仍然处于搁置状态。NCB 是相关数据";
                case 5509:
                    return "Windows 2000 无法按指定的配置启动，将换用先前可工作的配置";
                case 5600:
                    return "无法共享用户或脚本路径";
                case 5601:
                    return "计算机的密码在本地安全数据库中找不到";
                case 5602:
                    return "访问计算机的本地或网络安全数据库时，发生内部错误";
                case 5705:
                    return "Netlogon 服务用于记录数据库更改数据的日志高速缓存已损坏。Netlogon 服务正在复位更改日志文件";
                case 5728:
                    return "无法加载任何传输";
                case 5739:
                    return "此域的全局组数目超过可以复制到 LanMan BDC 的限制。请删除部分的全局组或删除域中的 LanManBDC";
                case 5742:
                    return "服务无法检索必要的消息，所以无法运行远程启动客户";
                case 5743:
                    return "服务发生严重的错误，无法从远程启动3Com 3Start 远程启动客户";
                case 5744:
                    return "服务发生严重的系统错误，即将关机";
                case 5760:
                    return "服务在分析 RPL 配置时出错";
                case 5761:
                    return "服务在创建所有配置的 RPL 配置文件时出错";
                case 5762:
                    return "服务在访问注册表时出错";
                case 5763:
                    return "服务在替换可能过期的 RPLDISK.SYS 时出错";
                case 5764:
                    return "服务在添加安全帐户或设置文件权限时出错。这些帐户是独立 RPL 工作站的 RPLUSER 本地组以及用户帐户";
                case 5765:
                    return "服务无法备份它的数据库";
                case 5766:
                    return "服务无法从它的数据库初始化。数据库可能找不到或损坏。服务会试图从备份数据库恢复该数据库";
                case 5767:
                    return "服务无法从备份数据库还原它的数据库。服务将不启动";
                case 5768:
                    return "服务无法从备份数据库还原它的数据库";
                case 5769:
                    return "服务无法从它还原的数据库初始化。服务将不启动";
                case 5771:
                    return "远程启动数据库采用 NT 3.5 / NT 3.51 格式。NT 正在转换其为 NT 4.0 格式。完成转换后，JETCONV 转换器将写出应用事件日志";
                case 5773:
                    return
                        "该 DC 的 DNS 服务器不支持动态 DNS。将文件 $1$SystemRoot/System32/Config/netlogon.dns$1$中的 DNS 记录添加到伺服那个文件中引用的域的 DNS 服务器";
                case 5781:
                    return "由于没有可以使用的 DNS 服务器，一个或更多 DNS 记录的动态注册和注销未成功";
                case 6000:
                    return "无法加密指定的文件";
                case 6001:
                    return "指定的文件无法解密";
                case 6002:
                    return "指定的文件已加密，而且用户没有能力解密";
                case 6003:
                    return "这个系统没有有效的加密恢复策略配置";
                case 6004:
                    return "所需的加密驱动程序并未加载到系统中";
                case 6005:
                    return "文件加密所使用的加密驱动程序与目前加载的加密驱动程序不同";
                case 6006:
                    return "没有为用户定义的 EFS 关键字";
                case 6007:
                    return "指定的文件并未加密";
                case 6008:
                    return "指定的文件不是定义的 EFS 导出格式";
                case 6009:
                    return "指定的文件是只读文件";
                case 6010:
                    return "已为加密而停用目录";
                case 6011:
                    return "不信任服务器来进行远程加密操作";
                case 6118:
                    return "此工作组的服务器列表当前无法使用";
                case 6200:
                    return "要正常运行，任务计划程序服务的配置必须在系统帐户中运行。单独的任务可以被配置成在其他帐户中运行";
                case 7001:
                    return "指定的会话名称无效";
                case 7002:
                    return "指定的协议驱动程序无效";
                case 7003:
                    return "在系统路径上找不到指定的协议驱动程序";
                case 7004:
                    return "在系统路径上找不到指定的终端连接";
                case 7005:
                    return "不能为这个会话创建一个事件日志的注册键";
                case 7006:
                    return "同名的一个服务已经在系统中存在";
                case 7007:
                    return "在会话上一个关闭操作挂起";
                case 7008:
                    return "没有可用的输出缓冲器";
                case 7009:
                    return "找不到 MODEM.INF 文件";
                case 7010:
                    return "在 MODEM.INF 中没有找到调制解调器名称";
                case 7011:
                    return "调制解调器没有接受发送给它的指令。验证配置的调制解调器与连接的调制解调器是否匹配";
                case 7012:
                    return "调制解调器没有接受发送给它的指令。验证该调制解调器是否接线正确并且打开了电源开关";
                case 7013:
                    return "运载工具检测失败或者由于断开连接，运载工具已被丢弃";
                case 7014:
                    return "在要求的时间内没有发现拨号音。 确定电话线连接正确并可使用";
                case 7015:
                    return "在远程站点回叫时检测到了占线信号";
                case 7016:
                    return "在回叫时远程站点上检测到了声音";
                case 7017:
                    return "传输驱动程序错误";
                case 7022:
                    return "找不到指定的会话";
                case 7023:
                    return "指定的会话名称已处于使用中";
                case 7024:
                    return "由于终端连接目前正在忙于处理一个连接、断开连接、复位或删除操作，无法完成该请求的操作";
                case 7025:
                    return "试图连接到其视频模式不受当前客户支持的会话";
                case 7035:
                    return "应用程序尝试启动 DOS 图形模式。不支持 DOS 图形模式";
                case 7037:
                    return "您的交互式登录权限已被禁用。请与您的管理员联系";
                case 7038:
                    return "该请求的操作只能在系统控制台上执行。这通常是一个驱动程序或系统 DLL 要求直接控制台访问的结果";
                case 7040:
                    return "客户未能对服务器连接消息作出响应";
                case 7041:
                    return "不支持断开控制台会话";
                case 7042:
                    return "不支持重新将一个断开的会话连接到控制台";
                case 7044:
                    return "远程控制另一个会话的请求被拒绝";
                case 7045:
                    return "拒绝请求的会话访问";
                case 7049:
                    return "指定的终端连接驱动程序无效";
                case 7050:
                    return "不能远程控制该请求的会话。这也许是由于该会话被中断或目前没有一个用户登录。而且，您不能从该系统控制台远程控制一个会话或远程控制系统控制台。并且，您不能远程控制您自己的当前会话";
                case 7051:
                    return "该请求的会话没有配置成允许远程控制";
                case 7052:
                    return "拒绝连接到这个终端服务器。终端服务器客户许可证目前正在被另一个用户使用。请与系统管理员联系，获取一份新的终端服务器客户，其许可证号码必须是有效的、唯一的";
                case 7053:
                    return "拒绝连接到这个终端服务器。还没有为这份终端服务器客户输入您的终端服务器客户许可证号码。请与系统管理员联系，为该终端服务器客户输入一个有效的、唯一的许可证号码";
                case 7054:
                    return "系统已达到其授权的登录限制。请以后再试一次";
                case 7055:
                    return "您正在使用的客户没有使用该系统的授权。您的登录请求被拒绝";
                case 7056:
                    return "系统许可证已过期。您的登录请求被拒绝";
                case 8001:
                    return "文件复制服务 API 被错误调用";
                case 8002:
                    return "无法启动文件复制服务";
                case 8003:
                    return "无法停止文件复制服务";
                case 8004:
                    return "文件复制服务 API 终止了请求。事件日志可能有详细信息";
                case 8005:
                    return "该文件复制服务中断了该请求。事件日志可能有详细信息";
                case 8006:
                    return "无法联系文件复制服务。事件日志可能有详细信息";
                case 8007:
                    return "由于该用户没有足够特权，文件复制服务不能满足该请求。事件日志可能有详细信息";
                case 8008:
                    return "由于验证的 RPC 无效，文件复制服务不能满足该请求。事件日志可能有详细信息";
                case 8009:
                    return "由于该用户在域控制器上没有足够特权，文件复制服务不能满足该请求。事件日志可能有详细信息";
                case 8010:
                    return "由于在域控制器上的验证的 RPC 无效，文件复制服务不能满足该请求。事件日志可能有详细信息";
                case 8011:
                    return "该文件复制服务无法与在域控制器上的文件复制服务通讯。事件日志可能有详细信息";
                case 8012:
                    return "在域控制器上的文件复制服务无法与这台计算机上的文件复制服务通讯。事件日志可能有详细信息";
                case 8013:
                    return "由于内部错误，该文件复制服务不能进入该系统卷中。事件日志可能有详细信息";
                case 8014:
                    return "由于内部超时，该文件复制服务不能进入该系统卷中。事件日志可能有详细信息";
                case 8015:
                    return "该文件复制服务无法处理此请求。该系统卷仍在忙于前一个请求";
                case 8016:
                    return "由于内部错误，该文件复制服务无法停止复制该系统卷。事件日志可能有详细信息";
                case 8017:
                    return "该文件复制服务检测到一个无效参数";
                case 8200:
                    return "在安装目录服务时出现一个错误。有关详细信息，请查看事件日志";
                case 8201:
                    return "目录服务在本地评估组成员身份";
                case 8202:
                    return "指定的目录服务属性或值不存在";
                case 8203:
                    return "指定给目录服务的属性语法无效";
                case 8204:
                    return "指定给目录服务的属性类型未定义";
                case 8205:
                    return "指定的目录服务属性或值已经存在";
                case 8206:
                    return "目录服务忙";
                case 8207:
                    return "该目录服务无效";
                case 8208:
                    return "目录服务无法分配相对标识号";
                case 8209:
                    return "目录服务已经用完了相对标识号池";
                case 8210:
                    return "由于目录服务不是该类操作的主控，未能执行操作";
                case 8211:
                    return "目录服务无法初始化分配相对标识号的子系统";
                case 8212:
                    return "该请求的操作没有满足一个或多个与该对象的类别相关的约束";
                case 8213:
                    return "目录服务只可以在一个页状对象上运行要求的操作";
                case 8214:
                    return "目录服务不能在一个对象的 RDN 属性上执行该请求的操作";
                case 8215:
                    return "目录服务检测出修改对象类别的尝试";
                case 8216:
                    return "不能执行请求的通过域的移动操作";
                case 8217:
                    return "无法联系全局编录服务器";
                case 8218:
                    return "策略对象是共享的并只可在根目录上修改";
                case 8219:
                    return "策略对象不存在";
                case 8220:
                    return "请求的策略信息只在目录服务中";
                case 8221:
                    return "域控制器升级目前正在使用中";
                case 8222:
                    return "域控制器升级目前不在使用中";
                case 8224:
                    return "出现一个操作错误";
                case 8225:
                    return "出现一个协议错误";
                case 8226:
                    return "已经超过这个请求的时间限制";
                case 8227:
                    return "已经超过这个请求的大小限制";
                case 8228:
                    return "已经超过这个请求的管理限制";
                case 8229:
                    return "比较的响应为假";
                case 8230:
                    return "比较的响应为真";
                case 8231:
                    return "这个服务器不支持请求的身份验证方式";
                case 8232:
                    return "这台服务器需要一个更安全的身份验证方式";
                case 8233:
                    return "不适当的身份验证";
                case 8234:
                    return "未知的身份验证机制";
                case 8235:
                    return "从服务器返回了一个建议";
                case 8236:
                    return "该服务器不支持该请求的关键扩展";
                case 8237:
                    return "这个请求需要一个安全的连接";
                case 8238:
                    return "不恰当的匹配";
                case 8239:
                    return "出现一个约束冲突";
                case 8240:
                    return "在服务器上没有这样一个对象";
                case 8241:
                    return "有一个别名问题";
                case 8242:
                    return "指定了一个无效的 dn 语法";
                case 8243:
                    return "该对象为叶对象";
                case 8244:
                    return "有一个别名废弃问题";
                ...
                case 8257:
                    return "没有返回结果";
                case 8258:
                    return "该服务器不支持该指定的控制";
                case 8259:
                    return "客户检测到一个参考循环";
                case 8260:
                    return "超过当前的参考限制";
                case 8301:
                    return "根目录对象必须是一个命名上下文的头。该根目录对象不能有实例父类";
                case 8302:
                    return "不能执行添加副本操作。名称上下文必须可写才能创建副本";
                case 8303:
                    return "出现一个对架构中未定义的一个属性的参考";
                case 8304:
                    return "超过了一个对象的最大尺寸";
                case 8305:
                    return "尝试向目录中添加一个已在使用中的名称的对象";
                case 8306:
                    return "尝试添加一个对象，该对象属于那类在架构中没有一个 RDN 定义的类别";
                case 8307:
                    return "尝试添加一个使用 RDN 的对象，但该 RDN 不是一个在架构中定义的 RDN ";
                case 8308:
                    return "在对象中找不到任何请求的属性";
                case 8309:
                    return "用户缓冲区太小";
                case 8310:
                    return "在操作中指定的属性不出现在对象上";
                case 8311:
                    return "修改操作非法。不允许该修改的某个方面";
                case 8312:
                    return "指定的对象太大";
                case 8313:
                    return "指定的实例类别无效";
                case 8314:
                    return "操作必须在主控 DSA 执行";
                case 8315:
                    return "必须指定对象类别属性";
                case 8316:
                    return "一个所需的属性丢失";
                case 8317:
                    return "尝试修改一个对象，将一个对该类别来讲是非法的属性包括进来";
                case 8318:
                    return "在对象上指定的属性已经存在";
                case 8320:
                    return "指定的属性不存在或没有值";
                case 8321:
                    return "为只有一个值的属性指定了多个值";
                case 8322:
                    return "属性值不在接受范围内";
                case 8323:
                    return "指定的值已存在";
                case 8324:
                    return "由于不存在于对象上，不能删除该属性";
                case 8325:
                    return "由于不存在于对象上，不能删除该属性值";
                case 8326:
                    return "指定的根对象不能是子参考";
                case 8327:
                    return "不允许链接";
                case 8328:
                    return "不允许链接的评估";
                case 8329:
                    return "由于对象的父类不是未实例化就是被删除了，所以不能执行操作";
                case 8330:
                    return "不允许有一个用别名的父类。别名是叶对象";
                case 8331:
                    return "对象和父类必须是同一种类，不是都是原件就是都是副本";
                case 8332:
                    return "由于子对象存在，操作不能执行。这个操作只能在叶对象上执行";
                case 8333:
                    return "没有找到目录对象";
                case 8334:
                    return "别名对象丢失";
                ...
                case 8341:
                    return "出现一个目录服务错误";
                case 8342:
                    return "操作只能在内部主控 DSA 对象上执行";
                case 8343:
                    return "对象必须为 DSA 类别";
                case 8344:
                    return "访问权不够不能执行该操作";
                case 8345:
                    return "由于父类不在可能的上级列表上，不能添加该对象";
                case 8346:
                    return "由于该属性处于“安全帐户管理器” (SAM)，不允许访问该属性";
                case 8347:
                    return "名称有太多部分";
                case 8348:
                    return "名称太长";
                case 8349:
                    return "名称值太长";
                case 8350:
                    return "目录服务遇到了一个错误分列名称";
                case 8351:
                    return "目录服务找不到一个名称的属性种类";
                case 8352:
                    return "该名称不能识别一个对象; 该名称识别一个幻象";
                case 8353:
                    return "安全描述符太短";
                case 8354:
                    return "安全描述符无效";
                case 8355:
                    return "为删除的对象创建名称失败";
                case 8356:
                    return "一个新子参考的父类必须存在";
                case 8357:
                    return "该对象必须是一个命名上下文";
                case 8358:
                    return "不允许添加一个不属于系统的属性";
                case 8359:
                    return "对象的类别必须是有结构的; 您不能实例化一个抽象的类别";
                case 8360:
                    return "找不到架构的对象";
                case 8361:
                    return "有这个 GUID (非活动的的或活动的)的本地对象已经存在";
                case 8362:
                    return "操作不能在一个后部链接上执行";
                case 8363:
                    return "找不到指定的命名上下文的互交参考";
                case 8364:
                    return "由于目录服务关闭，操作不能执行";
                case 8365:
                    return "目录服务请求无效";
                case 8366:
                    return "无法读取角色所有者属性";
                case 8367:
                    return "请求的 FSMO 操作失败。不能连接当前的 FSMO 盒";
                case 8368:
                    return "不允许跨过一个命名上下文修改 DN";
                case 8369:
                    return "由于属于系统，不能修改该属性";
                case 8370:
                    return "只有复制器可以执行这个功能";
                case 8371:
                    return "指定的类别没有定义";
                case 8372:
                    return "指定的类别不是一个子类别";
                ...
                case 8374:
                    return "交叉参考已经存在";
                case 8375:
                    return "不允许删除一个主控交叉参考";
                case 8376:
                    return "只在 NC 头上支持子目录树通知";
                case 8377:
                    return "通知筛选器太复杂";
                case 8378:
                    return "架构更新失败: 重复的 RDN";
                case 8379:
                    return "架构更新失败: 重复的 OID";
                case 8380:
                    return "架构更新失败: 重复的 MAPI 识别符";
                case 8381:
                    return "架构更新失败: 复制架构 id GUID";
                case 8382:
                    return "架构更新失败: 重复的 LDAP 显示名称";
                case 8383:
                    return "架构更新失败: 范围下部少于范围上部";
                case 8384:
                    return "架构更新失败: 语法不匹配";
                case 8385:
                    return "架构更新失败: 属性在必须包含中使用";
                case 8386:
                    return "架构更新失败: 属性在可能包含中使用";
                case 8387:
                    return "架构更新失败: 可能包含中的属性不存在";
                case 8388:
                    return "架构更新失败:必须包含中的属性不存在";
                case 8389:
                    return "架构更新失败: 在辅助类别列表中的类别不存在或不是一个辅助类别";
                case 8390:
                    return "架构更新失败: poss-superior 中的类别不存在";
                case 8391:
                    return "架构更新失败: 在 subclassof 列表中的类别不存在或不能满足等级规则";
                case 8392:
                    return "架构更新失败: Rdn-Att-Id 语法不对";
                case 8393:
                    return "架构更新失败: 类别作为辅助类别使用";
                case 8394:
                    return "架构更新失败: 类别作为子类别使用";
                case 8395:
                    return "架构更新失败: 类别作为 poss superior 使用";
                case 8396:
                    return "架构更新在重新计算验证缓存时失败";
                case 8397:
                    return "目录树删除没有完成。要继续删除目录树，必须再次发出请求";
                case 8398:
                    return "不能执行请求的删除操作";
                case 8399:
                    return "不能读取架构记录管理类别识别符";
                case 8400:
                    return "属性架构语法不对";
                case 8401:
                    return "不能缓存属性";
                ...
                case 8409:
                    return "出现一个数据错误";
                case 8410:
                    return "丢失一个属性 GOVERNSID";
                case 8411:
                    return "丢失一个所需要的属性";
                case 8412:
                    return "指定的命名上下文丢失了一个交叉参考";
                case 8413:
                    return "出现一个安全检查错误";
                case 8414:
                    return "没有加载架构";
                case 8415:
                    return "架构分配失败。请检查机器内存是否不足";
                case 8416:
                    return "为属性架构获得所需语法失败";
                case 8417:
                    return "全局编录验证失败。全局编录无效或不支持操作。目录的某些部分目前无效";
                case 8418:
                    return "由于有关服务器之间的架构不匹配，复制操作失败";
                case 8419:
                    return "找不到 DSA 对象";
                case 8420:
                    return "找不到命名上下文";
                ...
                case 8431:
                    return "目录服务遇到一个未知失败";
                case 8432:
                    return "根对象需要一个 $1$top$1$ 类别";
                case 8433:
                    return "这个目录服务器已关闭，并且不能接受新上浮单一主机操作角色的所有权";
                case 8434:
                    return "目录服务没有必需的配置信息，并且不能决定新上浮单一主机操作角色的所有权";
                case 8435:
                    return "该目录服务无法将一个或多个上浮单一主机操作角色传送给其它服务器";
                case 8436:
                    return "复制操作失败";
                case 8437:
                    return "为这个复制操作指定了一个无效的参数";
                case 8438:
                    return "目录服务太忙，现在无法完成这个复制操作";
                case 8439:
                    return "为这个复制操作指定的单一名称无效";
                case 8440:
                    return "为这一个复制操作所指定的命名上下文无效";
                case 8441:
                    return "为这个复制操作指定的单一名称已经存在";
                case 8442:
                    return "复制系统遇到一个内部错误";
                case 8443:
                    return "复制操作遇到数据库不一致问题";
                case 8444:
                    return "不能连接到为这个复制操作指定的服务器上";
                case 8445:
                    return "复制操作遇到一个有无效范例类型的对象";
                case 8446:
                    return "复制操作无法分配内存";
                case 8447:
                    return "复制操作遇到一个邮件系统错误";
                case 8448:
                    return "目标服务器的复制参考信息已经存在";
                case 8449:
                    return "目标服务器的复制参考信息不存在";
                case 8450:
                    return "由于是由另一台服务器上复制的，因此不能删除命名上下文";
                case 8451:
                    return "复制操作遇到一个数据库错误";
                case 8452:
                    return "命名上下文要被删除或没有从指定的服务器上复制";
                case 8453:
                    return "复制访问被拒绝";
                case 8454:
                    return "这个版本的目录服务不支持请求的操作";
                case 8455:
                    return "取消复制远程过程呼叫";
                case 8456:
                    return "源服务器目前拒绝复制请求";
                case 8457:
                    return "目标服务器当前拒绝复制请求";
                case 8458:
                    return "由于对象名称冲突，复制操作失败";
                case 8459:
                    return "复制源已被重新安装";
                case 8460:
                    return "由于一个所需父对象丢失，复制操作失败";
                case 8461:
                    return "复制操作被抢先";
                case 8462:
                    return "由于缺乏更新，放弃复制同步尝试";
                case 8463:
                    return "由于系统正在关闭，复制操作被中断了";
                case 8464:
                    return "由于目标部分属性设置不是一个源部分属性设置的子设置，复制同步尝试失败";
                case 8465:
                    return "由于主复制尝试从部分复制同步，复制同步尝试失败";
                case 8466:
                    return "已经与为这个复制操作的指定的服务器联系，但是该服务器无法与完成这个操作所需的另外一个服务器联系";
                case 8467:
                    return "在副本安装时，检测到一个使用的源和内部版本之间的架构不匹配，不能安装该副本";
                case 8468:
                    return "架构更新失败: 有同一连接标识符的属性已经存在";
                case 8469:
                    return "名称翻译: 常见处理错误";
                case 8470:
                    return "名称翻译: 不能找到该名称或权限不够，不能看到名称";
                case 8471:
                    return "名称翻译: 输入名称映射到多个输出名称";
                case 8472:
                    return "名称翻译: 找到输出名称，但是找不到相应的输出格式";
                case 8473:
                    return "名称翻译: 不能完全解析，只找到了域";
                case 8474:
                    return "名称翻译: 不接到线上，无法在客户机上执行纯粹的语法映射";
                case 8475:
                    return "不允许一个构造 att 修改";
                case 8476:
                    return "指定的 OM-Object 类别对指定语法的一个属性是不正确的";
                case 8477:
                    return "复制请求已暂停; 等待回答";
                case 8478:
                    return "要求的操作需要一个目录服务，但没有可用的";
                case 8479:
                    return "类别或属性的 LDAP 显示名称含有非 ASCII 字符";
                case 8480:
                    return "请求的查找操作只支持基本查找";
                case 8481:
                    return "查找未能从数据库检索属性";
                case 8482:
                    return "架构更新操作试图添加一个反向链接，但该反向链接没有相应的正向链接";
                case 8483:
                    return "跨域移动的来源和目标在对象日期上不一致。或者是来源，或者是目标没有对象的最后一个版本";
                case 8484:
                    return "跨域移动的来源和目标在对象当前的名称上不一致。或者是来源，或者是目标没有对象的最后一个版本";
                case 8485:
                    return "域间移动的来源和目标是一样的。调用程序应该使用本地移动操作，而不是域间移动操作";
                case 8486:
                    return "域间移动的来源和目标与目录林中的命名上下文不一致。来源或目标没有分区容器的最近版本";
                case 8487:
                    return "跨域移动的目标不是目标命名上下文的权威";
                case 8488:
                    return "跨域移动的来源和目标提供的来源对象的身份不一样。 来源或目标没有来源对象的最近版本";
                case 8489:
                    return "跨域移动的对象应该已经被目标服务器删除。来源服务器没有来源对象的最近版本";
                case 8490:
                    return "要求对 PDC FSMO 的专门访问权的另一个操作正在进行中";
                case 8491:
                    return "跨域移动没有成功，导致被移动对象有两个版本 - 一个在来源域，一个在目标域。需要删除目标对象，将系统还原到一致状态";
                case 8492:
                    return "因为不允许这个类别的跨域移动，或者对象有一些特点，如: 信任帐户或防止移动的受限制的 RID；所以不能将该对象跨域移动";
                case 8493:
                    return "一旦移动，不能将带有成员身份的对象跨域移动，这会侵犯帐户组的成员身份条件。从帐户组成员身份删除对象，再试一次";
                case 8494:
                    return "命名上下文标题必须是另一个命名上下文标题的直接子标题，而不是一个内节点的子标题";
                case 8495:
                    return "因为目录没有提议的命名上下文上面的命名上下文的副本，所以无法验证所提议的命名上下文的名称。请保证充当域命名主机的服务器已配置成全局编录服务器，并且服务器及其复制伙伴是最新的";
                case 8496:
                    return "目标域必须在本机模式中";
                case 8497:
                    return "因为服务器在指定域中没有基础结构容器，所以无法执行操作";
                case 8498:
                    return "不允许跨域移动帐户组";
                case 8499:
                    return "不允许跨域移动资源组";
                case 8500:
                    return "属性的搜索标志无效。ANR 位只在 Unicode 或 Teletex 字符串的属性上有效";
                case 8501:
                    return "不允许在将 NC 头作为子体的对象开始删除目录树";
                case 8502:
                    return "因为目录树在使用中，目录服务未能为删除目录树而将其锁定";
                case 8503:
                    return "删除目录树时，目录服务未能识别要删除的对象列表";
                case 8505:
                    return "只有管理员才能修改管理组的成员列表";
                case 8506:
                    return "不能改变域控制器帐户的主要组 ID";
                case 8507:
                    return "试图修改基础架构";
                case 8508:
                    return
                ...
                case 8509:
                    return "该域控制器上不允许架构更新。没有设置注册表项，或者 DC 不是架构 FSMO 角色所有者";
                case 8510:
                    return "无法在架构容器下创建这个类别的对象。在架构容器下，您只能创建属性架构和类别架构对象";
                case 8511:
                    return "副本/子项安装未能获取源 DC 上的架构容器的 objectVersion 属性。架构容器上的属性不存在，或者提供的凭据没有读取属性的权限";
                case 8512:
                    return "副本/子项安装未能读取 system32 目录中的文件 schema.ini 的 SCHEMA 段中的 objectVersion 属性";
                case 8513:
                    return "指定的组类型无效";
                case 8514:
                    return "如果域是安全启用的，在混合型域中不能嵌套全局组";
                case 8515:
                    return "如果域是安全启用的，在混合型域中不能嵌套本地组";
                case 8516:
                    return "全局组不能将本地组作为成员";
                case 8517:
                    return "全局组不能将通用组作为成员";
                case 8518:
                    return "通用组不能将本地组作为成员";
                case 8519:
                    return "全局组不能有跨域成员";
                case 8520:
                    return "本地组不能将另一个跨域本地组作为成员";
                case 8521:
                    return "包含主要成员的组不能改变为安全停用的组";
                case 8522:
                    return "架构缓冲加载未能转换类架构对象上的字符串默认值 SD";
                case 8523:
                    return "只有配置成全局编录服务器的 DSAs 才能充当域命名主机 FSMO 的角色";
                case 8524:
                    return "由于 DNS 查找故障，DSA 操作无法进行";
                case 8525:
                    return "处理一个对象的 DNS 主机名改动时，服务主要名称数值无法保持同步";
                case 8526:
                    return "未能读取安全描述符属性";
                case 8527:
                    return "没有找到请求的对象，但找到了具有那个密钥的对象";
                case 8528:
                    return "正在添加的链接属性的语法不正确。正向链接只能有语法 2.5.5.1、2.5.5.7 和 2.5.5.14，而反向链接只能有语法 2.5.5.1";
                case 8529:
                    return "安全帐户管理员需要获得启动密码";
                case 8530:
                    return "安全帐户管理员需要从软盘获得启动密钥";
                case 8531:
                    return "目录服务无法启动";
                case 8532:
                    return "未能启动目录服务";
                case 8533:
                    return "客户和服务器之间的连接要求数据包保密性";
                case 8534:
                    return "来源域跟目标域不在同一个目录林中";
                case 8535:
                    return "目标域必须在目录林中";
                case 8536:
                    return "该操作要求启用目标域审核";
                case 8537:
                    return "该操作无法为来源域找到 DC";
                case 8538:
                    return "来源对象必须是一个组或用户";
                case 8539:
                    return "来源对象的 SID 已经在目标目录林中";
                case 8540:
                    return "来源对象和目标对象必须属于同一类型";
                case 8542:
                    return "在复制请求中不能包括架构信息";
                case 8543:
                    return "由于架构不兼容性，无法完成复制操作";
                case 8544:
                    return "由于前一个架构的不兼容性，无法完成复制操作";
                case 8545:
                    return "因为源和目标都没有收到有关最近跨域启动操作的信息，所以无法应用复制更新";
                case 8546:
                    return "因为还有主控这个域的域控制器，所以无法删除请求的域";
                case 8547:
                    return "只能在全局编录服务器上执行请求的操作";
                case 8548:
                    return "本地组只能是同一个域中其他本地组的成员";
                case 8549:
                    return "外部安全主要成员不能是通用组的成员";
                case 8550:
                    return "出于安全，无法将属性复制到 GC";
                case 8551:
                    return "由于目前正在处理的修改太多，无法采取 PDC 的检查点";
                case 8552:
                    return "操作需要启用那个源域审核";
                case 8553:
                    return "安全主要对象仅能在域命名环境菜单中创建";
                case 8554:
                    return "服务主要名称(SPN) 无法建造，因为提供的主机名格式不适合";
                case 8555:
                    return "筛选器已传递建造的属性";
                case 8556:
                    return "unicodePwd 属性值必须括在双引号中";
                case 8557:
                    return "您的计算机无法加入域。已超出此域上允许创建的计算机帐户的最大值。请同系统管理员联系，复位或增加此限定值";
                case 8558:
                    return "由于安全原因，操作必须在目标 DC 上运行";
                case 8559:
                    return "由于安全原因，源 DC 必须是 Service Pack 4 或更新版本";
                case 8560:
                    return "在树目录删除的操作中不能删除“关键目录服务系统”对象。数目录删除操作可能只进行了一部分";
                case 9001:
                    return "DNS 服务器无法解释格式";
                case 9002:
                    return "DNS 服务器失败";
                case 9003:
                    return "DNS 名称不存在";
                case 9004:
                    return "名称服务器不支持 DNS 请求";
                case 9005:
                    return "拒绝 DNS 操作";
                case 9006:
                    return "不应该存在的 DNS 名称仍然存在";
                case 9007:
                    return "不应该存在的 DNS RR 集仍然存在";
                case 9008:
                    return "应该存在的 DNS RR 集不存在";
                case 9009:
                    return "DNS 服务器对区域没有权威";
                case 9010:
                    return "在更新或 prereq 中的 DNS 名称不在区域中";
                case 9016:
                    return "DNS 签名验证失败";
                case 9017:
                    return "DNS 不正确密钥";
                case 9018:
                    return "DNS 签名验证过期";
                case 9501:
                    return "为 DNS 查询找不到记录";
                case 9502:
                    return "无效 DNS 包";
                case 9503:
                    return "没有 DNS 包";
                case 9504:
                    return "DNS 错误，请检查 rcode";
                case 9505:
                    return "为保险的 DNS 包";
                case 9551:
                    return "无效的 DNS 种类";
                ...
                case 9553:
                    return "无效的属性";
                case 9554:
                    return "稍后再试一次 DNS 操作";
                case 9555:
                    return "给出的记录名称和种类不是单一的";
                case 9556:
                    return "DNS 名称不符合 RFC 说明";
                case 9557:
                    return "DNS 名称是一个完全合格的 DNS 名称";
                case 9558:
                    return "DNS 名称以“.”分隔(多标签)";
                case 9559:
                    return "DNS 名称是单一部分名称";
                case 9560:
                    return "DNS 名称含有无效字符";
                case 9561:
                    return "DNS 名称完全是数字的";
                ...
                case 9604:
                    return "无效 DNS 区域配置";
                case 9605:
                    return "DNS 区域没有颁发机构记录的开始(SOA)";
                case 9606:
                    return "DNS 区域没有“名称服务器” (NS)的记录";
                case 9607:
                    return "DNS 区域已锁定";
                case 9608:
                    return "DNS 区域创建失败";
                ...
                case 9616:
                    return "需要 WINS 服务器";
                case 9617:
                    return "NBTSTAT 初始化呼叫失败";
                case 9618:
                    return "颁发机构起始(SOA)删除无效";
                case 9651:
                    return "主要 DNS 区域需要数据文件";
                case 9652:
                    return "DNS 区域的无效数据文件名称";
                case 9653:
                    return "为 DNS 区域打开数据文件失败";
                case 9654:
                    return "为 DNS 区域写数据文件失败";
                case 9655:
                    return "为 DNS 区域读取数据文件时失败";
                case 9701:
                    return "DNS 记录不存在";
                case 9702:
                    return "DNS 记录格式错误";
                ...
                case 9707:
                    return "检测到 CNAME 循环";
                case 9708:
                    return "节点为一个 CNAME DNS 记录";
                case 9709:
                    return "指定名称的 CNAME 记录已经存在";
                case 9710:
                    return "记录不在 DNS 区域根目录";
                case 9711:
                    return "DNS 记录已经存在";
                case 9712:
                    return "次要 DNS 区域数据错误";
                case 9713:
                    return "不能创建 DNS 缓存数据";
                case 9714:
                    return "DNS 名称不存在";
                case 9715:
                    return "不能创建指针(PTR)记录";
                case 9716:
                    return "DNS 域没有被删除";
                case 9717:
                    return "该目录服务无效";
                case 9718:
                    return "DNS 区域已经在目录服务中存在";
                case 9719:
                    return "DNS 服务器没有为目录服务集合 DNS 区域创建或读取启动文件";
                case 9751:
                    return "完成 DNS AXFR (区域复制)";
                case 9752:
                    return "DNS 区域复制失败";
                case 9753:
                    return "添加了本地 WINS 服务器";
                case 9801:
                    return "安全更新呼叫需要继续更新请求";
                case 9851:
                    return "TCP/IP 没有安装网络协议";
                case 9852:
                    return "没有为本地系统配置 DNS 服务器";
                case 10004:
                    return "一个封锁操作被对 WSACancelBlockingCall 的调用中断";
                case 10009:
                    return "提供的文件句柄无效";
                case 10013:
                    return "以一种访问权限不允许的方式做了一个访问套接字的尝试";
                case 10014:
                    return "系统检测到在一个调用中尝试使用指针参数时的无效指针地址";
                case 10022:
                    return "提供了一个无效的参数";
                case 10024:
                    return "打开的套接字太多";
                ...
                case 10040:
                    return "一个在数据报套接字上发送的消息大于内部消息缓冲器或其它一些网络限制，或该用户用于接收数据报的缓冲器比数据报小";
                case 10041:
                    return "在套接字函数调用中指定的一个协议不支持请求的套接字类别的语法";
                case 10042:
                    return "在 getsockopt 或 setsockopt 调用中指定的一个未知的、无效的或不受支持的选项或层次";
                case 10043:
                    return "请求的协议还没有在系统中配置，或者没有它存在的迹象";
                case 10044:
                    return "在这个地址家族中不存在对指定的插槽种类的支持";
                case 10045:
                    return "参考的对象种类不支持尝试的操作";
                case 10046:
                ...
                case 10059:
                    return "对某个内核对象的引用过多";
                case 10060:
                    return "由于连接方在一段时间后没有正确的答复或连接的主机没有反应，连接尝试失败";
                case 10061:
                    return "不能做任何连接，因为目标机器积极地拒绝它";
                case 10062:
                    return "无法翻译名称";
                case 10063:
                    return "名称组件或名称太长";
                ...
                case 10103:
                    return "在处理这个调用时，就开始调用 WSALookupServiceEnd。该调用被删除";
                case 10104:
                    return "过程调用无效";
                case 10105:
                    return "请求的服务提供程序无效";
                case 10106:
                    return "没有加载或初始化请求的服务提供程序";
                case 10107:
                    return "从来不应失败的系统调用失败了";
                case 10108:
                    return "没有已知的此服务。在指定的名称空间中找不这个服务";
                case 10109:
                    return "找不到指定的类别";
                case 10110:
                    return "WSALookupServiceNext 不能返回更多的结果";
                ...
                case 11001:
                    return "不知道这样的主机";
                case 11002:
                    return "这是在主机名解析时常出现的暂时错误，并且意味着本地服务器没有从权威服务器上收到响应";
                case 11003:
                    return "在数据寻找中出现一个不可恢复的错误";
                case 11004:
                    return "请求的名称有效并且是在数据库中找到，但是它没有相关的正确的数据";
                case 11005:
                    return "至少到达了一个保留";
                case 11006:
                    return "至少到达了一个路径";
                ...
                case 11010:
                    return "错误是由于资源不足造成";
                case 11011:
                    return "由于管理原因被拒绝 - 无效凭据";
                case 11012:
                    return "未知或有冲突类型";
                case 11013:
                    return "某一部分的 filterspec 或 providerspecific 缓冲区有问题";
                case 11014:
                    return "flowspec 的某部分有问题";
                case 11015:
                    return "一般性 QOS 错误";
                case 11016:
                    return "在流程规格中发现一个无效的或不可识别的服务类型";
                case 11017:
                    return "在 QOS 结构中发现一个无效的或不一致的流程规格";
                case 11018:
                    return "无效的 QOS 提供程序特定缓冲区";
                case 11019:
                    return "使用了无效的 QOS 筛选器样式";
                case 11020:
                    return "使用了无效的 QOS 筛选器类型";
                case 11021:
                    return "FLOWDESCRIPTOR 中指定的 QOS FILTERSPEC 数量不正确";
                case 11022:
                    return "在 QOS 提供程序特定缓冲区中指定了一个 ObjectLength 字符域无效的对象";
                case 11023:
                    return "QOS 结构中指定的流程描述符数量不正确";
                case 11024:
                    return "在 QOS 提供程序特定缓冲区中发现一个不可识别的对象";
                case 11025:
                    return "在 QOS 提供程序特定缓冲区中发现一个无效的策略对象";
                case 11026:
                    return "在流程描述符列表中发现一个无效的 QOS 流程描述符";
                case 11027:
                    return "在 QOS 提供程序特定缓冲区中发现一个无效的或不一致的流程规格";
                case 11028:
                    return "在 QOS 提供程序特定缓冲区中发现一个无效的 FILTERSPEC";
                case 11029:
                    return "在 QOS 提供程序特定缓冲区中发现一个无效的波形丢弃模式对象";
                case 11030:
                    return "在 QOS 提供程序特定缓冲区中发现一个无效的成形速率对象";
                case 11031:
                    return "在 QOS 提供程序特定缓冲区中发现一个保留的策略因素";
            }
            return "错误编号：" + code;
        }
